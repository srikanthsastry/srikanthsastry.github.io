...
**The core design principle for the [suggestible actor](/garden/suggestible-actor-properties/): convert ambient knowledge into local context.** Human developers carry implicit knowledge (org norms, conventions, institutional history) that the AI agent cannot access. Making that knowledge explicit and local is how you steer an actor that has no judgment.
