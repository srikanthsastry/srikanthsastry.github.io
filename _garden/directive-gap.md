...
The directive gap: the distance between the human's goal (with all their ambient knowledge) and the context actually available to the agent during execution. The human who said "implement feature X" had knowledge about the codebase, conventions, and likely obstacles that was never made local. This gap is the root cause of most [suggestible-actor](/garden/suggestible-actor-properties/) failures. When it is wide, the agent [confabulates](/garden/confabulation-is-plausible/).
