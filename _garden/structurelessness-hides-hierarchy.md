...
garden_type: note
maturity: evergreen
tags: [governance, organizational-design, hierarchy, command-and-control]
created: 2026-04-26
related_posts:
...
The implication for C&C governance: the answer to C&C's failure in tech is not to eliminate hierarchy. It is to redesign where decisions happen within the hierarchy.
