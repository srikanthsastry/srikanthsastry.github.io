...
The alternative is DAMP (Descriptive And Meaningful Phrases): accept repetition in exchange for each test being self-contained, readable, and independently modifiable. The cost of repetition is low — test code changes less frequently — while the cost of tangled test infrastructure is high.
