...
The colloquial term for this is "command and control." That term is imprecise and means different things to different people. What dominates the tech industry is something more specific. Burns and Stalker come close with the notion of [mechanistic organization](https://en.wikipedia.org/wiki/Mechanistic_and_organic_systems) in 1961: rigid hierarchy, top-down decision-making, formal procedures, accountability through the chain of command.
