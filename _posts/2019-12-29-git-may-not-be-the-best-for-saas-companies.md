...
In the past half decade or so, Git has sky rocketed in popularity and is becoming the defacto choice for version control. While I understand its popularity, I have found it to be a [poor fit for one specific, but popular, environment](/garden/vcs-should-match-development-model/): SaaS development in a medium to large size enterprise.
...
![](/assets/images/2019/12/push-rejected-rebaseor-merge-38-git-push-force-git-commit-amend-git-25695648.png)
...
![](/assets/images/2019/12/32n8q6.jpg)
